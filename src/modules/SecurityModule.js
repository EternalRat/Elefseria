...
module.exports = class SecurityModule extends BaseModule {
	commands = new Map();
	...
	isThisModuleEnabled(guildId) {
		return ModuleConfig.get({ moduleName: "Security", guildId: guildId });
	}
	...
	changeModuleState(guildId) {
		ModuleConfig.set({ moduleName: "Security", guildId: guildId, state: !ModuleConfig.get({ moduleName: "Security", guildId: guildId })});
	}
