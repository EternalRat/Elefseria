...
module.exports = class FunModule extends BaseModule {
	...
	isThisModuleEnabled(guildId) {
		return ModuleConfig.get({ moduleName: "Fun", guildId: guildId });
	}
	...
	changeModuleState(guildId) {
		ModuleConfig.set({ moduleName: "Fun", guildId: guildId, state: !ModuleConfig.get({ moduleName: "Fun", guildId: guildId })});
	}
