...
module.exports = class SettingsModule extends BaseModule {
	...
	isThisModuleEnabled(guildId) {
		return ModuleConfig.get({ moduleName: "Settings", guildId: guildId });
	}
	...
	changeModuleState(guildId) {
		ModuleConfig.set({ moduleName: "Settings", guildId: guildId, state: !ModuleConfig.get({ moduleName: "Settings", guildId: guildId })});
	}
