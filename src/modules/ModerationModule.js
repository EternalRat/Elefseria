...
module.exports = class ModerationModule extends BaseModule {
	...
	isThisModuleEnabled(guildId) {
		return ModuleConfig.get({ moduleName: "Moderation", guildId: guildId });
	}
	...
	changeModuleState(guildId) {
		ModuleConfig.set({ moduleName: "Moderation", guildId: guildId, state: !ModuleConfig.get({ moduleName: "Moderation", guildId: guildId })});
	}
