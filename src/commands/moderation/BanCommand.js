...
module.exports = class BanCommand extends BaseCommand {
	...
	async run(client, msg, args) {
		...
		if (msg.mentions.users.first() || msg.guild.member(args[0])) {
			...
			if (msg.guild.member(msg.author).roles.highest.position <= bUser.roles.highest.position) return msg.channel.send("That person can't be banned!");
